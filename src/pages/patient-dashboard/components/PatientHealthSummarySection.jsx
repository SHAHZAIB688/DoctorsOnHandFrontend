const PatientHealthSummarySection = ({
  ...
  <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm lg:col-span-2">
    ...
    <p className="mt-1 text-sm text-slate-600">Update your medical basics for faster consultations.</p>
    ...
    <form onSubmit={saveHealthSummary} className="mt-5 grid gap-4 md:grid-cols-2">
      ...
      <div className="md:col-span-2">
        ...
        <textarea
          ...
          className="w-full rounded-xl border border-slate-300 px-3 py-2 text-sm text-slate-700 outline-none transition focus:border-brand-500 focus:ring-2 focus:ring-brand-500/20 resize-none"
        />
      </div>
