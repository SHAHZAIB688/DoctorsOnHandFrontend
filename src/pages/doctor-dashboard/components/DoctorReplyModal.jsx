  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        <h3 className="text-xl font-bold text-slate-800 mb-1">{t("dash.doctorReply.title")}</h3>
        <p className="text-sm text-slate-500 mb-6">{t("dash.doctorReply.subtitle")}</p>

        <form onSubmit={onSubmit} className="space-y-5">
          <textarea
            rows="4"
            required
            placeholder={t("dash.doctorReply.placeholder")}
